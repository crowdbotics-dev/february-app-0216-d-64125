...
const Untitled3 = () => {
  ...
  useEffect(() => {
    dispatch( // added this: my action required parameters!
  ...
  const {
    entities: Boredapi20_response_get_GetActivities
  } = useSelector(state => state.Boredapi20_response_get_GetActivities);
      ...
      backgroundColor: "#f0f0f1"
        ...
        <View style={styles.column2}>
          <Text style={styles.FZYairKB}>
            ...
            {Boredapi20_response_get_GetActivities?.length ? Boredapi20_response_get_GetActivities[0].activity : ""}
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>;
